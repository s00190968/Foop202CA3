    ...
    internal static class WorldFactory
    {
        internal static World CreateWorld()
        {
            ...
            newWorld.AddLocation(-1, -1, "Farmer's House",
                ...
                "Farmhouse.jpg");
            newWorld.GetLocationAt(-1, -1).TraderHere = TraderFactory.GetTraderByName("Farmer Ted");
            ...
            newWorld.AddLocation(-1, 0, "Trading Shop",
                ...
                "Trader.jpg");
            newWorld.GetLocationAt(-1, 0).TraderHere = TraderFactory.GetTraderByName("Susan");
            ...
            newWorld.AddLocation(0, 1, "Herbalist's hut",
                ...
                "HerbalistsHut.jpg");
            newWorld.GetLocationAt(0, 1).TraderHere = TraderFactory.GetTraderByName("Herbalist Pete");
